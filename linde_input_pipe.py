...
#todo        self.norm_std, self.page_features, self.page_ix = it_tensors
    ...
    # original: x_hits, y_hits, dow, lagged_hits, pf_agent, pf_country, pf_site, page_ix,
    # original                      page_popularity, year_autocorr, quarter_autocorr
    def make_features(self, x_hits, y_hits, dow, lagged_hits,  pf_country,  page_ix,
        ...
        flat_page_features = tf.concat([ pf_country,  stacked_features], axis=0)
...
def page_features(inp: VarFeeder):
    ...
    return (inp.hits, inp.pf_country,
